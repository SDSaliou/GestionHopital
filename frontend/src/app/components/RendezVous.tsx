...
const RV: React.FC<RVProps> = ({ fetchRV }) => {
  ...
  const fetchPatients = async () => {
    try {
      const  resPatient  = await axios.get<Patient[]>("https://gestion-hopital-api.vercel.app/patients");
  ...
  const handleAddRV = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setLoading(true);
    try {
      await axios.post("https://gestion-hopital-api.vercel.app/rendezvous/add", {
